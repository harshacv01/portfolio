...
const features = [
  {
    ...
    description:
      "Modern, responsive, and efficient websites tailored to your needs.",
    icon: "💻",
  },
  {
    title: "Assignment Help",
    description: "Expert guidance and support to ace your academic tasks.",
    icon: "📝",
  },
  {
    title: "Career Support",
    description:
      "Personalized advice and resources to boost your career growth.",
    icon: "🎯",
  },
  {
    title: "Bug Resolution",
    description:
      "Quick and effective fixes to keep your projects running smoothly.",
    icon: "🔧",
  },
  {
    title: "SEO Optimization",
    description:
      "Proven strategies to improve visibility and drive organic traffic.",
    icon: "🚀",
  },
];
