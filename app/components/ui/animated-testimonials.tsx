...
export const AnimatedTestimonials = ({
  ...
  // Only generate random rotations on the client side
  const getRandomRotation = (index: number) => {
    if (!isClient) return 0
    // Use a deterministic seed based on index for more stable animations
    return ((index * 7) % 11) - 5
  }
    ...
    <div className="mx-auto max-w-sm px-4 py-20 font-sans antialiased md:max-w-4xl md:px-8 lg:px-12">
      <div className="relative grid grid-cols-1 gap-20 md:grid-cols-2">
              ...
              {testimonials.map((testimonial, index) => (
                <motion.div
                  ...
                  initial={{
                    ...
                    scale: 0.9,
                    z: -100,
                    rotate: isClient ? getRandomRotation(index) : 0,
                  }}
                  animate={{
        ...
        <div className="flex flex-col justify-between py-4">
          ...
          <div className="flex gap-4 pt-12 md:pt-0 justify-center sm:justify-start">
            <button
              onClick={handlePrev}
